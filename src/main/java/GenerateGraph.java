import org.gephi.io.generator.plugin.DynamicGraph;
     ...
     18 */
        ...
        ProjectController pc = Lookup.getDefault().lookup(ProjectController.class);pc.newProject();
        ...
        randomGraph2.generate(container.getLoader());importController.process(container2, new AppendProcessor(), workspace); //Use AppendProcessor to append to current workspace
